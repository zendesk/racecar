...
module Racecar
  class Config < KingKonf::Config
    ...
    desc "Commit stored offsets on a timer even when no messages have been processed, refreshing their retention so an idle consumer group doesn't lose its position"
